...
- **IA:** Groq (LLaMA 3.3 70B) para generación de presupuestos estructurados con reglas de negocio del sector construcción español.
...
- API REST Flask + PostgreSQL + panel React para trabajadores de campo.
- Infraestructura en Proxmox LXC con Cloudflare Pages y Tunnels.
